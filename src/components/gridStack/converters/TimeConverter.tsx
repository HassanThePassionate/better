...
const timeUnits: Unit[] = [
  ...
  { name: "Microsecond", symbol: "μs", conversionFactor: 1000000 },
  { name: "Nanosecond", symbol: "ns", conversionFactor: 1000000000 },
...
export default function TimeConverter() {
  ...
  const [baseUnit, setBaseUnit] = useState<Unit>(timeUnits[0]);
  ...
  const calculateConversions = () => {
    ...
    timeUnits.forEach((unit) => {
      // Convert base value to seconds first, then to target unit
      const valueInSeconds = baseValue / baseUnit.conversionFactor;
      newValues[unit.symbol] = valueInSeconds * unit.conversionFactor;
    });
