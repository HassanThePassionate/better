    ...
    <div className='w-1/2 border-r border-border bg-card overflow-hidden flex flex-col'>
      <div className='p-3'>
        ...
        <div className='grid grid-cols-7 mb-1 '>
          {["S", "M", "T", "W", "T", "F", "S"].map((day, index) => (
            <div
              key={index}
              className='text-center text-[10px]  text-xs text-foreground font-medium'
            >
              {day}
            </div>
          ))}
      ...
      <div className='mt-auto border-t border-border  p-2  flex justify-center space-x-2'>
        <Button
          ...
          className='text-[10px] h-6   text-xs rounded-full border-border text-gray-700 hover:bg-hover text-text px-3'
        >
          Today
        </Button>
        <Button
          ...
          className='text-[10px] h-6  text-xs rounded-full border-border text-brand hover:bg-hover px-3 flex items-center'
        >
